...
MODULE SpAMM_ALGEBRA
  ...
  REAL(SpAMM_DOUBLE) :: SpAMM_Add_QuTree_2_QuTree_InPlace_Alpha,  &
       SpAMM_Add_QuTree_2_QuTree_InPlace_Beta,   &
       SpAMM_Add_BiTree_2_BiTree_InPlace_Alpha,  &
       SpAMM_Add_BiTree_2_BiTree_InPlace_Beta,   &
       SpAMM_Add_BiTree_2_BiTree_RePlace_Alpha,  &
       SpAMM_Add_BiTree_2_BiTree_RePlace_Beta,   &
       SpAMM_Add_Identity_2_QuTree_InPlace_Alpha,&
       SpAMM_Threshold_Multiply_QuTree_x_QuTree, &
       SpAMM_Threshold_Multiply_QuTree_x_BiTree
  !===============================================================================
  !  EXTERNAL
  !===============================================================================
#ifdef SPAMM_DOUBLE
  ...
  INTERFACE Multiply
     MODULE PROCEDURE SpAMM_Multiply_QuTree_x_QuTree, &
          SpAMM_Multiply_QuTree_x_Scalar, &
          SpAMM_Multiply_QuTree_x_BiTree, &
          SpAMM_Multiply_BiTree_x_Scalar
  END INTERFACE
  INTERFACE Trace
  ...
  INTERFACE Add
     MODULE PROCEDURE SpAMM_Add_QuTree_2_QuTree_InPlace, &
          SpAMM_Add_BiTree_2_BiTree_InPlace, &
          SpAMM_Add_BiTree_2_BiTree_RePlace, &
          SpAMM_Add_Identity_2_QuTree_InPlace
  END INTERFACE
  INTERFACE Filter
     MODULE PROCEDURE SpAMM_Filter_QuTree
  END INTERFACE
  INTERFACE Norm
     MODULE PROCEDURE SpAMM_Norm_Reduce_QuTree,SpAMM_Norm_Reduce_BiTree
  END INTERFACE
  INTERFACE Dot
...
CONTAINS 
  !================================================================= 
  ! SPAMM CONTAINERS FOR RECURSIVE MATRIX-MATRIX ALGEBRA 
  !================================================================= 
  ! The Sparse Approximate Matrix-Multiply (SpAMM): C <- A.B
  ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
  ...
  RECURSIVE SUBROUTINE SpAMM_Multiply_QuTree_x_Scalar(qA,a)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Multiply_QuTree_x_Scalar",2)
  ...
  SUBROUTINE SpAMM_Add_QuTree_2_QuTree_InPlace(qA,qB,Alpha,Beta)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial    
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Add_QuTree_2_QuTree_InPlace",3)
  ...
  FUNCTION SpAMM_Trace_QuTree(qA) RESULT(a)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Trace_QuTree",5)
  ...
  SUBROUTINE SpAMM_Filter_QuTree(qA,Tau)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Filter_QuTree",6)
  ...
  FUNCTION SpAMM_Norm_Reduce_QuTree(qA) RESULT(Norm)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Norm_Reduce_QuTree",7)
  ...
  SUBROUTINE SpAMM_Add_BiTree_2_BiTree_RePlace(bC,Alpha,bA,Beta,bB)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial    
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Add_BiTree_2_BiTree_RePlace",8)
  ...
  SUBROUTINE SpAMM_Add_BiTree_2_BiTree_InPlace(bA,Alpha,bB,Beta)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial    
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Add_BiTree_2_BiTree_InPlace",9)
  ...
  FUNCTION SpAMM_Dot_Product_BiTree(bA,bB) RESULT(dot)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Dot_Product_BiTree",10)
  ...
  SUBROUTINE SpAMM_Multiply_QuTree_x_BiTree(qA,bB,bC,LocalThreshold)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Multiply_QuTree_x_BiTree",11)
  ...
  RECURSIVE SUBROUTINE SpAMM_Multiply_BiTree_x_Scalar(bA,a)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Multiply_BiTree_x_Scalar",12)
  ...
  FUNCTION SpAMM_Norm_Reduce_BiTree(bA) RESULT(Norm)
    ...
    !$OMP TASKWAIT
    TTotal=SpAMM_IPM_GET_TIME()-TInitial
    CALL SpAMM_Time_Stamp(TTotal,"SpAMM_Norm_Reduce_BiTree",13)
  ...
  RECURSIVE SUBROUTINE SpAMM_Multiply_QuTree_x_QuTree_Recur(qC,qA,qB,Depth)
    ...
    IF(ASSOCIATED(qA).AND.ASSOCIATED(qB))THEN
       ...
       IF(Depth==SpAMM_TOTAL_DEPTH)THEN
          ...
          CALL DGEMM("N","N",SpAMM_BLOCK_SIZE,SpAMM_BLOCK_SIZE,SpAMM_BLOCK_SIZE,  &
                     SpAMM_One,qA%Blok(1,1),SpAMM_BLOCK_SIZE,qB%Blok(1,1),SpAMM_BLOCK_SIZE, &
                     SpAMM_One,qC%Blok(1,1),SpAMM_BLOCK_SIZE)
#else
          qC%Blok=qC%Blok+MATMUL(qA%Blok,qB%Blok)
  ...
  RECURSIVE SUBROUTINE SpAMM_Multiply_QuTree_x_BiTree_Recur(bC,qA,bB,Depth)
    ...
    IF(ASSOCIATED(qA).AND.ASSOCIATED(bB))THEN
       ...
       IF(Depth==SpAMM_TOTAL_DEPTH)THEN
          ...
          END IF
          ! Accumulate
          bC%Vect=bC%Vect+MATMUL(qA%Blok,bB%Vect)
       ELSE
#ifdef _OPENMP
          ! Put a check on the stack 
          DepthOK=.TRUE. 

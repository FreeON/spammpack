...
results regarding stability and compression. This represenation begins with a most permisive (but still effective) 
...
Then, starting with $\tau_0 \sim .1$ and $\mu_0 \sim .1$, it may be possible to build up a nested product represenation 
of the full factor with accelerative ``thin slice''  increments;  $\Delta \tau \sim .1$ and $\Delta \mu \sim .1$. 

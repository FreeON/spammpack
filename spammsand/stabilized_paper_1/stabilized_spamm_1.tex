...
with convergence towards identity, $\widetilde{\mat{x}}_k \leftarrow \mat{I}\left( \widetilde{\mat{x}}_{k-1} \right)$.  Towards convergence,  
...
which are recursively brought towards unity along the $i=k$ diagonal. Then, each product involving $\widetilde{\mat{x}}_k$ is a 
a near reflection onto itself; a near involution about the $ijk$ cube-diagonal.  

Because the $\tt SpAMM$ error obeys the multiplicative Cauchy-Schwarz bound, Eq.~(),  the 
cooresponding culled-octree follows the $i=j$ plane, about the $ijk$ cube-diagonal, resolving 
...
towards convergence, we should achieve a fast involution, involving reflections about the cube-diagonal. 

...
that are simply algorithms based on fast spatial and metric querry \cite{Sammet} and local approximation \cite{}.  
...
{\em e.g.} based on strong Euclidian locality and with iteration towards the identity.  
...
+ h_\alpha [ \widetilde{\mat{x}}_{k-2}] \cdot \delta \mat{y}_{k-2}  \,.
%%\cdot \delta \mat{z}_{k-2} \cdot \mat{s}
%\end{equation}
\end{multline}

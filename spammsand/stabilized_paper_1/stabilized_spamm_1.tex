...
\end{equation}
determines the total first order stability in the dual instance, wilst the differential of the single instance is:
...
This formulation considers changes about the resolvent, seperating orientational effects 
of the directional derivatives, set by the underlying exact linear algebra, from 

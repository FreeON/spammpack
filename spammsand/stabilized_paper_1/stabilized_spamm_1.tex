...
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/y_dual_1_cant.png}} 
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/y_dual_15_cant.png}} 
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/z_dual_1_cant.png}} 
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/z_dual_15_cant.png}} 
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/x_dual_1_cant.png}} 
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/x_dual_15_cant.png}} 
%\fbox{ \includegraphics[width=2.4cm,trim={1.3cm .1cm 1.3cm .1cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/z_dual_14_cant.png}} 
\caption{
...
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_stab_thin_slices/y_stab_r_1_cant.png}} 
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_stab_thin_slices/y_stab_r_15_cant.png}} 
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_stab_thin_slices/z_stab_1_cant.png}} 
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_stab_thin_slices/z_stab_15_cant.png}} 
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_stab_thin_slices/x_stab_r_1_cant.png}} 
\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{fig_33_8x_tube_cond_10_stab_thin_slices/x_stab_r_15_cant.png}} 
%\fbox{ \includegraphics[width=2.4cm,trim={1.3cm .1cm 1.3cm .1cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/z_dual_14_cant.png}} 
...
\begin{figure}[h] \label{Lensing2}
%\fbox{ \includegraphics[width=3.8cm,trim={2.cm .6cm 2.cm .8cm},clip]{y_dual_38_cant1.png}} 
\fbox{ \includegraphics[width=3.6cm,trim={20.6cm  .0cm 20.6cm .0cm},clip]{fig_bcsstk14/y_dual_38_y_zoomview.png}}
\fbox{ \includegraphics[width=3.6cm,trim={23.cm 0.6cm 23.cm 5.6cm},clip]{fig_bcsstk14/x_dual_38_x_zoomview.png} }
\caption{green is the $\mat{a}$, maroon is $\mat{b}$ and purple is $c$. Axes may be labeled incorrectly. }
\end{figure}
...
%I(s) is a gossamer pass function, providing converage to the range x=s^1/2.b
...
and also with respect to an outer simulation loop, {\em e.g.} cooresponding to time iteration.
 ...
 \fbox{ \includegraphics[width=2.3cm,trim={2.5cm 0.2cm 2.3cm 0.8cm},clip]{fig_33_8x_tube_cond_10_stab_thin_slices/z_stab_11_isov.png}} 
 \fbox{ \includegraphics[width=2.3cm,trim={2.5cm 0.2cm 2.3cm 0.8cm},clip]{fig_33_8x_tube_cond_10_stab_thin_slices/z_stab_11_isov.png}} 
 \fbox{ \includegraphics[width=2.3cm,trim={2.5cm 0.2cm 2.3cm 0.8cm},clip]{fig_33_8x_tube_cond_10_stab_thin_slices/z_stab_11_isov.png}} 
 \caption{}
 \end{figure}
...
%{\em e.g.} locally dense, locally Strassen-like, localiy sampled in a non-determanisticaly way,  

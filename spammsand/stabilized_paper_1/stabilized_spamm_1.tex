...
ill-conditioned problems can be challenging \cite{}.  

In cases of
extreme degeneracy, hierarchical semi-seperable (reduced rank)
algorithms can offer effective complexity reduction \cite{}. 

However, opportunities maybe found also in the product streem 
...
generic iterations may enable a competitive  approach to {\em implicit} computation of the full inverse factor.

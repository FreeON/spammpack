...
% \begin{eqnarray}
%  \mat{x}_{\delta \widehat{ \mat{y}}_{k-1}} &=& \lim_{\tau \rightarrow 0} \frac{ \mat{x} \left( \mat{y}_{k-1} + \tau \delta {\mat{y}}_{k-1} ,  {\mat{z}}_{k-1}  \right)
% -\mat{x} \left( \mat{y}_{k-1}  ,  {\mat{z}}_{k-1} \right)  }{\tau}  \\ 
%                                      &=&   \mat{y}_{\delta \widehat{ \mat{y}}_{k-1}} \cdot \mat{z}_{k-1}  + \mat{y}_{k-1}  \cdot \mat{z}_{\delta \widehat{ \mat{y}}_{k-1}} 
% \end{eqnarray}
...
\begin{multline}
 \mat{y}_{\delta \widehat{ \mat{y}}_{k-1}} = \delta \widehat{\mat{y}}_{k-1} \cdot h_\alpha \left[ \mat{x}_{k-1} \right]\\ 
                                     + \mat{y}_{k-1} \cdot h'_\alpha \left[ \mat{x}_{k-1} \right] \cdot \delta \widehat{\mat{y}}_{k-1} \cdot \mat{z}_{k-1}
\end{multiline}
\begin{equation}
 \mat{z}_{\delta \widehat{ \mat{y}}_{k-1}} =  \mat{z}_{k-1} \cdot h'_\alpha \left[ \mat{x}_{k-1} \right] \cdot \delta \widehat{\mat{y}}_{k-1} \cdot \mat{z}_{k-1}
\end{equation}

\begin{multline} 
 \mat{x}_{\delta \widehat{ \mat{z}}_{k-1}} = \delta \widehat{\mat{y}}_{k-1} \cdot h_\alpha \left[ \mat{x}_{k-1} \right] \\  +
 \mat{y}_{k-1} \cdot \{  
h'_\alpha \left[ \mat{x}_{k-1} \right] \cdot \delta \widehat{\mat{y}}_{k-1} \cdot \mat{z}_{k-1}  \\ +
\mat{z}_{k-1} \cdot h'_\alpha \left[ \mat{x}_{k-1} \right] \cdot \delta \widehat{\mat{y}}_{k-1} \} \cdot \mat{z}_{k-1} 
\end{multiline}


\begin{equation}
\mat{x}_{\delta \widehat{\mat{z}}_{k-1}} = \lim_{\tau \rightarrow 0} 
\frac{ \mat{x} \left( {\mat{y}}_{k-1} , \mat{z}_{k-1} +\tau  \delta {\mat{z}}_{k-1} \right)
     - \mat{x} \left(\, {\mat{y}}_{k-1} , \mat{z}_{k-1} \right)  }{\tau} 
\end{equation}

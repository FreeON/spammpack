...
\begin{eqnarray}\label{cannonical}Then, using
\begin{equation}
...
\end{eqnarray}
In addition to the dual channel instance, we also consider the ``single''Then, using
\begin{equation}
  h_\alpha \left[ \widetilde{\mat{x}}_{k-2} \right]
=  h_\alpha \left[ \mat{x}_{k-2} \right] +  h'_\alpha  \delta \mat{x}_{k-2} \, 
\end{equation}
 channel version of square root iteration,

...
\fbox{ \includegraphics[width=3.8cm,trim={4.cm  .6cm 4.cm 1.8cm},clip]{fig_bcsstk14/y_dual_38_cant2.png}}
\fbox{ \includegraphics[width=3.8cm,trim={22.cm .6cm 22.cm .8cm},clip]{fig_bcsstk14/x_dual_38_gossamer.png}  }
\caption{green is the $\mat{a}$, maroon is $\mat{b}$ and purple is $c$. Axes may be labeled incorrectly. }
\end{figure}

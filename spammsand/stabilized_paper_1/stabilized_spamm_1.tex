...
the $\tt SpAMM$ approximation is greatly enhanced by an increasing Euclidean locality of this kind. 

In addition to spatial locality, Warren and Salmon eploited temporal locality of the $n$-body (octree) 
task space, using previously accumulated histories to hierarchically rebalance and repartition  
distributed tree work in a communication optimal way.  In a similar way, we showed how related 
persistence data can be used to achieve strong scaling in the $\tt SpAMM$ $n$-body approach to 
matrix algebra \cite{}.  There are many additional opportunities for exploiting persistence data 
and temporal locality, but we won't persue the topic further any furhter here.  
...
and also with respect to an outer simulation loop, {\em e.g.} cooresponding to time iteration.
 ...
 \begin{figure}[h] \label{figxxx}
 \fbox{ \includegraphics[width=2.4cm,trim={19.3cm 1cm 19.3cm 3cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/z_dual_11_isov.png}} 
 \fbox{ \includegraphics[width=2.4cm,trim={19.3cm 1cm 19.3cm 3cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/z_dual_11_isov.png}} 
 \fbox{ \includegraphics[width=2.4cm,trim={19.3cm 1cm 19.3cm 3cm},clip]{fig_33_8x_tube_cond_10_dual_thin_slices/z_dual_11_isov.png}} 
 \caption{}
 \end{figure}

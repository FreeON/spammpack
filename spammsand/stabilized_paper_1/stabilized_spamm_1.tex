...
\end{equation}
and orderings that are locality preserving \cite{}, yeilding matrices with an approximate, block-by-magnitude structure as described in Refs. \cite{}.
...
\end{equation}
Here, we hope to develop understanding and control the flow of occlusion errors under iteration, 

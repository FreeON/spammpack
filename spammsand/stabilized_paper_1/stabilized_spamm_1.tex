...
these transformations correlate support with a representation independent linear form, {\em eg.} of the generalized eigenproblem. 
...
other disciplines.  Comprehensive surveys of these methods in the numerical linear algebra is given by Benzi \cite{Benzi99,Benzi02}. 

...
In the $\tt SpAMM$ approach to fast multixplication, a volume of significant contributions is culled from the 
$ijk$-cube of tensor intermediates, with error bounded by Eq.~(\ref{bound}).  
As explained by Demmel, Dumitriu and Holz (DDH; Ref.~\cite{Demmel07}), this makes $\ot$ {\em stable}.
 

$\tt SpAMM$ is broadly related to {\em generalized n-body} methods, poularized by Grey \cite{}.  
In our development, generalized methods are simply a reflection of {\em genericity} \cite{} in 
...
This evolution cooresponds to an  ongoing economization and radical simplification

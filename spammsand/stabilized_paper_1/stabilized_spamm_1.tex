...
\begin{multline}
 \mat{z}_{k-2} \cdot h_\alpha \left[ \widetilde{\mat{x}}_{k-2} \right]  
=  \mat{z}_{k-2}  \cdot \left( \right. \\  \left. h_\alpha \left[ \mat{x}_{k-2} \right] +  h'_\alpha  \delta \mat{x}_{k-2} + {\cal O} \left( \tau^2 \right)  
\, \right)
\end{multline}

\begin{multline}
 \delta {\mat{z}}_{k-1} \approx \Delta^{\widetilde{\mat{z}}_{k-2} \cdot h_\alpha \left[ \widetilde{\mat{x}}_{k-2}\right]}_\tau 
 +\delta \mat{z}_{k-2} \cdot h_\alpha \left[\widetilde{\mat{x}}_{k-2} \right]  \\
+ h'_\alpha \left( \delta \mat{y}_{k-2} \cdot \mat{z}_{k-2} + \mat{y}_{k-2} \cdot \delta \mat{z}_{k-2} \right)
\end{multline}

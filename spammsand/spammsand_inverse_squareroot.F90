...
!       sc=1d0
       ...
       IF(DoDuals)tHeN
          ...
          y_dual => SpAMM_tree_2d_symm_copy_tree_2d_symm( y_tmp, in_O = y_dual, threshold_O = tau )
...
#ifdef DENSE_DIAGNOSTICS
          CALL SpAMM_convert_tree_2d_symm_to_dense( y_tmp, y_tld_k_stab )
#else
#endif
          ! |x_n> = <y_n|z_n>

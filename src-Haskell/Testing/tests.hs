...
multValueByValue = do valueTree1 <- mmReadTree "Matrices/value2coor.txt"
...
multValueByRect = do valueTree <- mmReadTree "Matrices/value2coor.txt"
...
multRectByRect = do rectTree1 <- mmReadTree "Matrices/rect1coor.txt"
                    rectTree2 <- mmReadTree "Matrices/rect2coor.txt"
                    rectTree4 <- mmReadTree "Matrices/rect4coor.txt"
                    testReport "multRectByRect" (rectTree1 `treeMult`
                                                (treeTranspose rectTree2) == rectTree4)

multRectByRectArray = do rectTree1 <- mmReadTree "Matrices/rect1arr.txt"

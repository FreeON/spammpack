...
def main ():
  ...
  parser = argparse.ArgumentParser(description = "This script generates a "
      + "stream element kernel operating on 4x4 matrix blocks. The kernel "
      + "generated is written using assembly instructions assuming a "
  ...
  print("  movl  (multiply_stream, %r8, SIZEOF_UNSIGNED_INT), %r10d")
  print("  movl 4(multiply_stream, %r8, SIZEOF_UNSIGNED_INT), %r11d")
  print("  movl 8(multiply_stream, %r8, SIZEOF_UNSIGNED_INT), %r12d")
  print("  mov %r10, %r13")
  print("  mov %r11, %r14")
  print("  mov %r12, %r15")

...
def block_product (i, k, j):
  ...
  print("  mov linear_index_A, base_pointer_32")
  print("  imul $4*4*16, base_pointer")
  print("  mov norm_A_spill, pointer_A")
  print("  lea 0x%x(pointer_A, base_pointer), pointer_A" %(i*4*4*4+k*4*4))

  print("  mov norm_A_spill, base_pointer")
...
print("  mov 6*8(chunk_A), %9   # A_dilated.")
print("  mov 5*8(chunk_B), %r10 # B.")
print("  mov 5*8(chunk_C), %r11 # C.")
print("  lea (chunk_A, %r9),  %r9")
print("  lea (chunk_B, %r10), %r10")
print("  lea (chunk_C, %r11), %r11")
print("  mov %r9,  matrix_A_spill")
print("  mov %r10, matrix_B_spill")
print("  mov %r11, matrix_C_spill")
...
print("  xor %r12, %r12                 # Offset into norm array.")
print("  mov $1, %r10                   # Load number of norms in tier 0.")
print("")
print("  .balign 16")
print("tier_loop:")
print("  add %r10, %r12")
print("  sal $2, %r10                   # %r10 <- %r10*4.")
print("  add $1, %rax")
print("  cmp %rbx, %rax")
print("  jne tier_loop")
...
print("  mov 7*8(chunk_A), %r9")
print("  mov 7*8(chunk_B), %r10")
print("  mov 7*8(chunk_C), %r11")
print("  lea (chunk_A, %r9),  %r9")
print("  lea (chunk_B, %r10), %r10")
print("  lea (chunk_C, %r11), %r11")
print("  lea (%r9, %r12),  %r9")
print("  lea (%r10, %r12), %r10")
print("  lea (%r11, %r12), %r11")
print("  mov %r9,  norm_A_spill")
print("  mov %r10, norm_B_spill")
print("  mov %r11, norm_C_spill")
...
print("  movl  (multiply_stream, %r8), %r10")
print("  movl 4(multiply_stream, %r8), %r11")
print("  movl 8(multiply_stream, %r8), %r12")
print("  mov %r10, %r13")
print("  mov %r11, %r14")
print("  mov %r12, %r15")

print("")
print("  # Calculate base of norm offset.")
...
print("  imul $SPAMM_N_KERNEL*SPAMM_N_KERNEL*4*SIZEOF_FLOAT, %r13")
print("  imul $SPAMM_N_KERNEL*SPAMM_N_KERNEL*SIZEOF_FLOAT,   %r14")
print("  imul $SPAMM_N_KERNEL*SPAMM_N_KERNEL*SIZEOF_FLOAT,   %r15")

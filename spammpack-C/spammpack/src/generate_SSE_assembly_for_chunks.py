...
print("  # matrix.")
print("  imul $SPAMM_N_KERNEL_BLOCKED*SPAMM_N_KERNEL_BLOCKED, %r10")
print("  imul $SPAMM_N_KERNEL_BLOCKED*SPAMM_N_KERNEL_BLOCKED, %r11")
print("  imul $SPAMM_N_KERNEL_BLOCKED*SPAMM_N_KERNEL_BLOCKED, %r12")
...
print("  imul $SPAMM_N_KERNEL*SPAMM_N_KERNEL*4, %r13  # Dilated matrix A.")
print("  imul $SPAMM_N_KERNEL*SPAMM_N_KERNEL,   %r14  # Matrix B.")
print("  imul $SPAMM_N_KERNEL*SPAMM_N_KERNEL,   %r15  # Matrix C.")
